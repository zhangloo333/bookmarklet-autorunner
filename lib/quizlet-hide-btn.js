(function () {
  ...
  function addStyle() {
    let counter = 0;
    buildStyleTag();
    const btnCss = "#lei-hide-btn{position: fixed;top: 300px;left: 20px;width: 50px;height: 50px;}";
  ...
  function addStyleEn() {
    let counter = 0;
    const btnCss = "#lei-hide-btn__en{position: fixed;top: 250px;left: 20px;width: 50px;height: 50px;}";
    style.appendChild(document.createTextNode(btnCss));
    return function () {
      let css = "";
